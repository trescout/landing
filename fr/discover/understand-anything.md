# Interrogez vos codes avec l'intelligence artificielle

Avez-vous une base de code de 200 000 lignes ou une énorme archive de documents que vous ne reconnaissez pas ? Comprendre tout transforme tout ce contenu en une carte dans laquelle vous pouvez plonger et poser des questions. Il fonctionne de manière compatible avec Claude Code, Codex, Antigravity et Gemini CLI.
...
Installez le plugin Understand Anything dans Claude Code avec les commandes '/plugin marketplace add Lum1104/Understand-Anything' et '/plugin install compréhension-anything', puis dans mon projet exécutez '/understand' pour analyser la base de code et ouvrez le panneau interactif du graphique de connaissances avec '/understand-dashboard'.
...
---
Source : TreScout Découvrir · https://trescout.com/fr/discover/understand-anything/
