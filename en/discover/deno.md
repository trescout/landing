...
## Update
- August 6, 2026: Star 108,091 → 108,166, latest version v2.9.4 (July 23, 2026).
...
## Installation
**Installation on Mac or Linux systems**

```
curl -fsSL https://deno.land/install.sh | sh
```

**Installation with Homebrew on Mac**
...
## Running it
**Starting the prepared server file**
...
---
Source: TreScout Discover · https://trescout.com/en/discover/deno/
