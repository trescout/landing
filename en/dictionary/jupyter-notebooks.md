...
*Analogy: It's like a recipe book; You can see the ingredients and preparation (notes) on one side, and the cooked version of the dish (results) on the other side, on the same page.*
