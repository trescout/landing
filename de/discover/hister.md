...
- Die passende Binärdatei für Ihre Plattform herunterladen und unter Linux/macOS ausführbar machen
- Den Hister-Server im lokalen Listen-Modus starten
- Die lokale Weboberfläche öffnen
- Die Chrome- oder Firefox-Erweiterung installieren und die zu indexierenden Seiten auswählen
...
- GitHub-Repository →
- Schnellstart →
- README zu Datenschutz und Nutzung →
- Nutzungsablauf →
- Auf Türkisch lesen →
