# YouTube için Açık Kaynaklı Alternatif Arayüz
...
Invidious, YouTube için alternatif bir arayüz sunar ve resmî YouTube API’lerini kullanmaz. Herkese açık bir instance seçerek kullanabilir ya da ayrı kurulum belgelerini izleyerek kendi instance’ınızı barındırabilirsiniz. Proje AGPL-3.0 lisanslıdır ve geliştiriciler için belgelenmiş bir API sunar.

## Kimin için?

YouTube’a alternatif bir arayüz kullanmak, Google’dan bağımsız abonelikleri yönetmek veya kendi instance’ınızı barındırmak isteyenler.
