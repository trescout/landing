...
- 31 Ağustos 2026: Yıldız 12.180 → 12.210, son sürüm node-v2.14.2 (27 Ağustos 2026).
- 27 Ağustos 2026: Yıldız 12.179 → 12.180, son sürüm node-v2.14.1 (27 Ağustos 2026).
...
- **Ne sunar:** Hızlı belge ayrıştırma 
- **Ücret:** Ücretsiz · açık kaynak (Apache-2.0) 
- **Lisans:** Apache-2.0 · ayrıntı aşağıda 

## Ne kazandırır?
- Hızlı ve verimli belge ayrıştırma sağlar.
