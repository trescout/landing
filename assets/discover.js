...
(function () {
  ...
  var TABLO = {
    ...
    es: { onek: '/es/discover/', dizi: 'es', alan: 'tagline_es',
          etiket: { "Yapay zekâ araçları": "Herramientas de IA", "Geliştirici aracı": "Herramienta de desarrollo",
                    "Kod bilmeyenler için": "Sin código", "Öğrenme": "Aprendizaje", "Üretkenlik": "Productividad" },
          tumu: 'Todos', birim: ' herramientas', bos: 'Sin resultados. Cambie el filtro.', kopyalandi: 'Copiado ✓' },
